...
export const createStyleContext = <R extends StyleRecipe>(recipe: R) => {
  ...
  const withProvider = <T extends ElementType>(
    ...
    const StyledComponentWithProvider = forwardRef(
    ...
    StyledComponentWithProvider.displayName = 'StyledComponentWithProvider'

    return StyledComponentWithProvider as unknown as ComponentVariants<T, R>
  }
